...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0.5"
  s.summary      = "A short description of DiffMatchPatch."

  s.description  = <<-DESC
                   A longer description of DiffMatchPatch in Markdown format.
  ...
  # s.author       = { "Ashok Gelal" => "ashokgelal@gmail.com" }
  # s.authors      = { "Ashok Gelal" => "ashokgelal@gmail.com", "other author" => "email@address.com" }
  s.author       = 'JanX2'
